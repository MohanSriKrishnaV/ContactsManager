...
const LandingPage = () => {
    ...
    // dltContact(); setindlt(false); setpostdelete(true)}



    // const [indlt, setindlt] = useState(false);


    // {
    //     indlt ? <div className="delete-modal floating-modal">
    ...
    //         </svg>
    //         <h3>Delete</h3>
    //         <button onClick={() => { dltContact(); indlt(false); setpostdelete(true) }} className="modal-btn">Ok</button>
    //         <button onClick={() => setindlt(false)} className="modal-btn" >Cancel</button>
    //     </div> : null
    // }
    ...
    return (
        ...
        <div id="grid-container">
            ...
            <div id='navbar'>
                ...
                <button onClick={() => { setimportmodal(true); setpreimport(true); setdeletemodal(false) }} >Import</button>
                <button onClick={() => { setdeletemodal(true); setpredelete(true); setimportmodal(false) }}>Delete</button>
                    ...
                    >
                        ...
                        {filename && (
                            <>
                                ...
                                <button onClick={() => { formsubmit(); setpreimport(false); setpostimport(true) }} className="modal-btn">Submit</button>
                    ...
                    {(arr2.length !== 0) && <>{arr2.map((value) => {
                        return (
                            ...
                            <tr key={value._id} title={value.email} id="titlee">
                                ...
                                <td>{value.phone}</td>
                                <td>{value.country}</td>
                                <td><button id="edit"><div>

                                </div></button></td>
                                <td>
                                    <td><button id="dlt" onClick={(e) => { dltContact(e); setimportmodal(false); setpostdelete(true); setdeletemodal(true) }} name={value._id}>delete</button></td>
                                </td>
                            </tr>
                        )
